...
cur.execute("INSERT INTO profile (pfp, screenname, user_id, follower_list, following_list, post_list) VALUES (?, ?, ?, ?, ?, ?)", (file_to_BLOB("expics/pfp1.jpg"), 'bofadeezSlayer', 420, '12,', '13,', '21,'))
